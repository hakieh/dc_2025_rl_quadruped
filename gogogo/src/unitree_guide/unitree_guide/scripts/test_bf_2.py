...
rqt_plus=[-1.5,0.1,0.65,-1.5,-0.1,0.65,-1.5,0.1,1,-1.5,-0.1,1]
...
def get_model():
    model = Actor()
    weights=torch.load(f"./weights/train/2025-03-08/20:08_model_2650000.pt")
    # weights=torch.load(f"./weights/pyb/13:54_model_1500000.pt")
    # weights=torch.load(f"./weights/bf/model_14700.pt")
